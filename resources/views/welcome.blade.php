...
<head>
    ...
    <style>
        ...
        /* Fix for horizontal scroll/white space */
        html,
        body {
            overflow-x: hidden;
            width: 100%;
        ...
        .scroll-up-btn:hover {
            ...
            box-shadow: 0 15px 20px -5px rgba(197, 180, 157, 0.4);
        }
...
<body class="bg-gray-50">
    ...
    <!-- Header / Navbar -->
    <div class="bg-[#252525]">
        <!-- 1. HEADER (Only contains the visible bar) -->
        <header id="main-header" class="bg-[#252525] shadow-lg sticky top-0 z-40 py-6">
            <nav class="max-w-7xl mx-auto px-4 py-2 flex justify-between items-center">
                <a href="#" class="flex items-center gap-3">
                    <img id="nav-logo" src="images/white.png"
                        class="h-20 w-auto object-contain transition-all duration-500" alt="logo">
                </a>
                ...
                <ul class="hidden md:flex gap-10 items-center">
                    ...
                    <li class="group">
                        <a href="#home"
                            class="flex items-center gap-2 text-white hover:text-amber-500 transition-colors font-medium">
                    ...
                    <li class="group">
                        <a href="#fashion"
                            class="flex items-center gap-2 text-white hover:text-amber-500 transition-colors font-medium">
                            <i class="fa-brands fa-cotton-bureau text-xl"></i>
                            <span>Fashion</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#bag"
                            ...
                            <!-- Notification Badge -->
                            <span id="bag-count"
                                class="absolute -top-2 -right-3 bg-amber-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full border-2 border-[#252525] hidden">
                                0
                            </span>
                        </a>
                    </li>
                ...
                <!-- Mobile Toggle -->
                <button id="menu-open-button" class="md:hidden text-2xl text-white" aria-label="Open menu">
                    <i class="fas fa-bars"></i>
                </button>
            </nav>
        </header>

        <!-- 2. MOBILE ELEMENTS (Placed outside header for proper full-screen layering) -->
        <div id="menu-overlay"
            class="menu-overlay fixed inset-0 bg-black/60 opacity-0 pointer-events-none transition-opacity duration-300 md:hidden z-[60]">
        </div>

        <ul
            class="nav-menu fixed top-0 right-0 h-full w-72 bg-[#252525] shadow-xl transform translate-x-full transition-transform duration-300 p-6 space-y-6 md:hidden z-[70]">
            <li class="flex justify-end">
                <button id="menu-close-button" class="text-2xl text-white" aria-label="Close menu">
                    <i class="fas fa-xmark"></i>
                </button>
            </li>
            <li><a href="#home"
                    class="nav-link text-white hover:text-amber-500 transition-colors font-medium">Home</a></li>
            <li><a href="#about"
                    class="nav-link text-white hover:text-amber-500 transition-colors font-medium">About</a></li>
            <li><a href="#menu"
                    class="nav-link text-white hover:text-amber-500 transition-colors font-medium">Products</a></li>
            <li><a href="#gallery"
                    class="nav-link text-white hover:text-amber-500 transition-colors font-medium">Gallery</a></li>
            <li><a href="#contact"
                    class="nav-link text-white hover:text-amber-500 transition-colors font-medium">Contact</a></li>
        </ul>
    </div>
    ...
    <main>
            ...
            <div class="max-w-7xl mx-auto px-4">
                ...
                <div
                    ...
                    <div class="hidden lg:flex items-center justify-center bg-zinc-900/30 overflow-hidden relative">
                        ...
                        <div
                            class="h-[120%] w-[2px] bg-gradient-to-b from-transparent via-zinc-700 to-transparent rotate-12">
                        </div>
                    </div>
        ...
        <section class="bg-gray-100 py-32" id="menu">
            <div class="max-w-7xl mx-auto px-4">
                ...
                <ul class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 max-w-7xl mx-auto px-6"
                    id="product-gallery">
                    <!-- Product Item 1 -->
                    <li
                        ...
                        <a href="#" class="product-link block relative overflow-hidden">
                            <img src="images/postcard1.jpeg" alt="Hot Beverage"
                                data-material="Ceramic & Coffee Beans" data-cost="18.70"
        ...
        <div id="imagePopup"
            ...
            <!-- Close Button -->
            <span
                class="absolute top-5 right-5 text-white text-5xl cursor-pointer hover:text-gray-300 z-[110]">&times;</span>
            ...
            <div
                ...
                <div class="w-full md:w-2/3">
                    <img id="popupImg" class="w-full h-full max-h-[70vh] rounded-lg object-cover shadow-sm"
                        src="" alt="Popup View">
                </div>

                <!-- Right Side: Text/Details -->
                <div
                    class="w-full md:w-1/3 flex flex-col justify-center text-left px-6 py-4 bg-gray-50/50 rounded-r-xl">
                    <!-- Product Name -->
                    ...
                    <div class="mb-6">
                        <span
                            class="text-xs font-bold text-gray-400 uppercase tracking-widest block mb-1">Material</span>
                    ...
                    <div>
                        <span
                            class="text-xs font-bold text-gray-400 uppercase tracking-widest block mb-1">Description</span>
                ...
                <ul class="grid md:grid-cols-3 gap-8">
                    <li
                        ...
                        <a href="javascript:void(0)" class="gallery-link block">
                            <img src="images/minglong3.jpeg" alt="Gallery 1"
                    ...
                    <li
                        class="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl smooth-transition transform hover:scale-105">
                        <a href="javascript:void(0)" class="gallery-link block">
                            <img src="images/minglong1.jpeg" alt="Gallery 2"
                                class="w-full aspect-[3/4] object-cover">
                        </a>
                    </li>
                    ...
                    <li
                        class="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl smooth-transition transform hover:scale-105">
                        <a href="javascript:void(0)" class="gallery-link block">
                            <img src="images/minglong2.jpeg" alt="Gallery 3"
                                class="w-full aspect-[3/4] object-cover">
                        </a>
                    </li>
                    ...
                    <li
                        class="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl smooth-transition transform hover:scale-105">
                        <a href="javascript:void(0)" class="gallery-link block">
                            <img src="images/minglong6.jpeg" alt="Gallery 4"
                                class="w-full aspect-[3/4] object-cover">
                        </a>
                    </li>
                    ...
                    <li
                        class="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl smooth-transition transform hover:scale-105">
                        <a href="javascript:void(0)" class="gallery-link block">
                            <img src="images/minglong5.jpeg" alt="Gallery 5"
                                class="w-full aspect-[3/4] object-cover">
                        </a>
                    </li>
                    ...
                    <li
                        class="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl smooth-transition transform hover:scale-105">
                        <a href="javascript:void(0)" class="gallery-link block">
                            <img src="images/minglong7.jpeg" alt="Gallery 6"
                                class="w-full aspect-[3/4] object-cover">
                        </a>
                    </li>
                </ul>
        ...
        <footer class="bg-gray-950 text-white py-12">
            <div class="max-w-7xl mx-auto px-4 text-center">
                <p class="mb-6 text-lg font-semibold">© 2026 Gimas Studio. All rights reserved.</p>
                <div class="flex justify-center gap-6 mb-6">
                    <a href="#" class="text-amber-600 hover:text-amber-400 smooth-transition text-2xl"><i
                ...
                <p class="text-gray-400">
                    <a href="#" class="hover:text-amber-500 smooth-transition">Privacy Policy</a>
                    <span class="mx-3">•</span>
                    <a href="#" class="hover:text-amber-500 smooth-transition">Refund Policy</a>
                </p>
            </div>
        </footer>
    </main>
